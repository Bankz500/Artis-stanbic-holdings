 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(r=>{if(ye(r)){const a=r.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(r=>r).join(" ")}}function ye(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const C="@firebase/app",N="0.10.17";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d=new ie("@firebase/app"),Se="@firebase/app-compat",Be="@firebase/analytics-compat",De="@firebase/analytics",we="@firebase/app-check-compat",Ae="@firebase/app-check",Ce="@firebase/auth",Ie="@firebase/auth-compat",ve="@firebase/database",Te="@firebase/data-connect",Me="@firebase/database-compat",Oe="@firebase/functions",$e="@firebase/functions-compat",Re="@firebase/installations",Ne="@firebase/installations-compat",He="@firebase/messaging",Le="@firebase/messaging-compat",Pe="@firebase/performance",xe="@firebase/performance-compat",Ve="@firebase/remote-config",Fe="@firebase/remote-config-compat",We="@firebase/storage",je="@firebase/storage-compat",Ue="@firebase/firestore",ke="@firebase/vertexai",Ge="@firebase/firestore-compat",Ke="firebase",Je={[C]:"fire-core",[Se]:"fire-core-compat",[De]:"fire-analytics",[Be]:"fire-analytics-compat",[Ae]:"fire-app-check",[we]:"fire-app-check-compat",[Ce]:"fire-auth",[Ie]:"fire-auth-compat",[ve]:"fire-rtdb",[Te]:"fire-data-connect",[Me]:"fire-rtdb-compat",[Oe]:"fire-fn",[$e]:"fire-fn-compat",[Re]:"fire-iid",[Ne]:"fire-iid-compat",[He]:"fire-fcm",[Le]:"fire-fcm-compat",[Pe]:"fire-perf",[xe]:"fire-perf-compat",[Ve]:"fire-rc",[Fe]:"fire-rc-compat",[We]:"fire-gcs",[je]:"fire-gcs-compat",[Ue]:"fire-fst",[Ge]:"fire-fst-compat",[ke]:"fire-vertex","fire-js":"fire-js",[Ke]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye=new Map,ze=new Map,H=new Map;function L(t,e){try{t.container.addComponent(e)}catch(r){d.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,r)}}function I(t){const e=t.name;if(H.has(e))return d.debug(`There were multiple attempts to register component ${e}.`),!1;H.set(e,t);for(const r of Ye.values())L(r,t);for(const r of ze.values())L(r,t);return!0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const et=1024,tt=30*24*60*60*1e3;class rt{constructor(e){this.container=e,this._heartbeatsCache=null;const r=this.container.getProvider("app").getImmediate();this._storage=new at(r),this._heartbeatsCachePromise=this._storage.read().then(a=>(this._heartbeatsCache=a,a))}async triggerHeartbeat(){var e,r;try{const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=x();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((r=this._heartbeatsCache)===null||r===void 0?void 0:r.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s)?void 0:(this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const c=new Date(o.date).valueOf();return Date.now()-c<=tt}),this._storage.overwrite(this._heartbeatsCache))}catch(a){d.warn(a)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const r=x(),{heartbeatsToSend:a,unsentEntries:n}=nt(this._heartbeatsCache.heartbeats),s=W(JSON.stringify({version:2,heartbeats:a}));return this._heartbeatsCache.lastSentHeartbeatDate=r,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(r){return d.warn(r),""}}}function x(){return new Date().toISOString().substring(0,10)}function nt(t,e=et){const r=[];let a=t.slice();for(const n of t){const s=r.find(o=>o.agent===n.agent);if(s){if(s.dates.push(n.date),V(r)>e){s.dates.pop();break}}else if(r.push({agent:n.agent,dates:[n.date]}),V(r)>e){r.pop();break}a=a.slice(1)}return{heartbeatsToSend:r,unsentEntries:a}}class at{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Q()?q().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const r=await qe(this.app);return r!=null&&r.heartbeats?r:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var r;if(await this._canUseIndexedDBPromise){const n=await this.read();return P(this.app,{lastSentHeartbeatDate:(r=e.lastSentHeartbeatDate)!==null&&r!==void 0?r:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var r;if(await this._canUseIndexedDBPromise){const n=await this.read();return P(this.app,{lastSentHeartbeatDate:(r=e.lastSentHeartbeatDate)!==null&&r!==void 0?r:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}else return}}function V(t){return W(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function st(t){I(new D("platform-logger",e=>new _e(e),"PRIVATE")),I(new D("heartbeat",e=>new rt(e),"PRIVATE")),E(C,N,t),E(C,N,"esm2017"),E("fire-js","")}st("");var ot="firebase",it="11.1.0";/**
 * @license
